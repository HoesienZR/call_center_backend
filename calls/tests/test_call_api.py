...
class CallAPITest(TestCase):
    def setUp(self):
        ...
        self.admin_user = User.objects.create_superuser(username="admin", phone_number="1000000000", password="admin123")
    ...
    def test_edit_call(self):
        ...
        data = {"notes": "Updated notes", "edit_reason": "Testing edit"}
