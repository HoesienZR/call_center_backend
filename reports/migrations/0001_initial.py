    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='call_statistics', to='contacts.contact', verbose_name='مخاطب')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='call_statistics', to='projects.project', verbose_name='پروژه')),
            ],
            options={
